      ...
      function(froalaConfig) {
        ...
        return {
          ...
          link: function(scope, element, attrs, ngModel) {
            ...
            if (
              SPECIAL_TAGS.indexOf(element.prop("tagName").toLowerCase()) != -1
            ) {
              specialTag = true;
            }
            ...
            ctrl.createEditor = function(froalaInitOptions) {
              ...
              if (!ctrl.editorInitialized) {
                ...
                ctrl.registerEventsWithCallbacks(
                  "froalaEditor.initializationDelayed",
                  function() {
                    ngModel.$render();
                  }
                );
                ...
                for (var eventName in ctrl.options.events) {
                  if (ctrl.options.events.hasOwnProperty(eventName)) {
                    ctrl.registerEventsWithCallbacks(
                      eventName,
                      ctrl.options.events[eventName]
                    );
                  }
                }

                element.innerHTML = ctrl.froalaElement = element
                  .froalaEditor(ctrl.options)
            ...
            ctrl.updateModelView = function() {
              ...
              if (specialTag) {
                ...
                for (var i = 0; i < attributeNodes.length; i++) {
                  ...
                  if (
                    ctrl.options.angularIgnoreAttrs &&
                    ctrl.options.angularIgnoreAttrs.indexOf(attrName) != -1
                  ) {
                    continue;
                  }
